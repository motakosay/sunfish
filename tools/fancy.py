    ...
    while rubik_index < len(rubik_moves):
        ...
        if board.turn == chess.WHITE:
            ...
            try:
                ...
                continue  # re-print board and re-prompt

            if uci != expected:
                print(f"\nyou should review the game!")
...
async def play(engine, board, selfplay, bothhumans, Rubik_mode, pvs, time_limit, debug=False):
    ...
    while not board.is_game_over():
        ...
        if bothhumans:
            ...
            board.push(move) #or to remove
            rubik_index += 1 #or to remove
